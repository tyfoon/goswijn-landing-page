            ...
            <div className="max-w-xl space-y-8 animate-on-scroll relative z-30">
              <div className="space-y-6 relative z-30">
                <h2 className="text-4xl font-bold leading-tight tracking-tight text-foreground md:text-5xl lg:text-6xl relative z-30">
                  <span className="block">Breakthrough changes.</span>
      ...
      <section className="relative bg-background py-12 px-6 md:px-12 lg:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 lg:gap-16">
            <img src={googleLogo} alt="" className="h-6 md:h-7 w-auto max-w-[120px] object-contain grayscale opacity-60 hover:opacity-80 transition-opacity" />
