...
export const evidenceData: Record<string, EvidenceCard> = {
  "multi-geo": {
    ...
    bullets: [
      ...
      { label: "Google DoubleClick", detail: "Director Sales Benelux, Nordics" },
  ...
  "scale-ups": {
    ...
    columns: [
      ...
      },
      {
        ...
        situation:
          "A $30M+ B2C PE/Founder-backed SaaS business requiring transition to a more cost efficient and predictable model.",
