      ...
      <div className="space-y-4">
        {bookingOptions.map((option, index) => (
          <Card
            ...
            className="group p-4 bg-background/50 backdrop-blur-sm border-border/50 hover:border-foreground/40 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer animate-on-scroll"
            style={{ animationDelay: `${index * 0.1}s` }}
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-3 flex-1">
                <div className="p-2 rounded-full bg-muted group-hover:bg-foreground/10 transition-colors duration-300">
                  <Clock className="h-5 w-5 text-foreground" />
                </div>
                <div>
                  <h3 className="text-lg text-foreground mb-0.5 group-hover:text-foreground/80 transition-colors">
                    {option.duration} minutes
                  </h3>
                  <p className="text-foreground/70 text-xs">{option.description}</p>
                </div>
              </div>
              <div className="flex flex-col items-end gap-2">
                <p className="text-xl text-foreground">{option.price}</p>
                <Button
                  size="sm"
                  className="whitespace-nowrap shadow-md hover:shadow-xl transition-all duration-300 pointer-events-none text-xs"
                >
                  Book Now
                </Button>
              </div>
